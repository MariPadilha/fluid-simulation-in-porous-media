...
__global__ void contorno_superior_inferior(double *dev_pn, int imax, int jmax){
...
__global__ void contorno_esquerdo_direito(double *dev_pn, int imax, int jmax){
...
__global__ void contorno_cantos(double *pn, int imax, int jmax){
