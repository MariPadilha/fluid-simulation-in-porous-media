...
//--- upwind_V ---
__global__ void calc_upwind_Vj(double *dev_fn, double *dev_fs, double *dev_fe, double *dev_fw, double *dev_vm, double *dev_um, double *dev_areav_n, 
    ...
    double *dev_dydudx, double *dev_q_art, double *dev_xm, double *dev_liga_poros, double re, double **p, double **t, double *dev_rv, int jmax, 
    int i, double b_art, double invfr2, double darcy_number, double cf){
...
void calc_upwind_Vj(double *dev_um, double *dev_vm, double **p, double *dev_rv, double **t, int i){
    int threads = 256;
    dim3 blocks = grid_1d(jmax, threads);

    calc_upwind_Vj<<<blocks, threads>>>(dev_fn, dev_fs, dev_fe, dev_fw, dev_vm, dev_um, dev_areav_n, dev_areav_s,  dev_areav_e,
        ...
        re, p, t, dev_rv, jmax, i, iterations.b_art, invfr2, darcy_number, cf);
