...
//--- upwind_V ---
__global__ void calc_upwind_Vj(double *dev_fn, double *dev_fs, double *dev_fe, double *dev_fw, double **vm, double **um, double *dev_areav_n, 
    ...
    double *dev_dydudx, double *dev_q_art, double *dev_xm, double *dev_liga_poros, double re, double **p, double **t, double **rv, int jmax, 
...
void calc_upwind_Vj(double **um, double **vm, double **p, double **rv, double **t, int i){
    int threads = 256;
    dim3 blocks = grid_1d(jmax, threads);

    calc_upwind_Vj<<<blocks, threads>>>(dev_fn, dev_fs, dev_fe, dev_fw, vm, um, dev_areav_n, dev_areav_s,  dev_areav_e,
        ...
        re, p, t, rv, jmax, i, iterations.b_art, invfr2, darcy_number, cf);
