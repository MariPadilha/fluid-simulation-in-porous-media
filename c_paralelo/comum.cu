...
////////////////////////////matrizes linearizadas////////////////////////////////////
    ...
    cudaMallocManaged((void**)&dev_fw, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_fe, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_fs, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_fn, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_df, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dn, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_ds, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_de, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dw, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_aw, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_ae, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_as, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_an, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_ap, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_w, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_e, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_s, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_n, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_p, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_p, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dudxdx, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dxdvdy, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_q_art, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dvdydy, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_dydudx, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_w, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_e, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_s, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_n, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_aww, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_aee, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_ass, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_ann, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_ww, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_ee, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_ss, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_u_nn, sizeof(double)*(imax+2)*(jmax+1));
    ...
    cudaMallocManaged((void**)&dev_afw, sizeof(double)*(imax+1)*(jmax+1));                                  
    cudaMallocManaged((void**)&dev_afe, sizeof(double)*(imax+1)*(jmax+1));                                  
    cudaMallocManaged((void**)&dev_afn, sizeof(double)*(imax+1)*(jmax+1));                                  
    cudaMallocManaged((void**)&dev_afs, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_artdivu, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_ww, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_ee, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_ss, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_v_nn, sizeof(double)*(imax+2)*(jmax+1));
    cudaMallocManaged((void**)&dev_artdivv, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_dzudx, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_dzvdy, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_dp, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_dcudx, sizeof(double)*(imax+1)*(jmax+1));
    cudaMallocManaged((void**)&dev_dcvdy, sizeof(double)*(imax+1)*(jmax+1));
